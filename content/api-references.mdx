...
To begin using the WalletLabels API, you first need to obtain an API key. Please [register here](https://tally.so/r/mO7PrR) to get started.
...
| --- | --- | --- |
| `_id` | String | Unique identifier for the label record. |
...
Test the API live in our [playground](https://chat.openai.com/c/1249d274-3d7a-4296-bfb1-bcccaaa1fff6#). Try out different requests and see real-time responses.
...
-   API Key Registration: [Get an API key](https://tally.so/r/mO7PrR)

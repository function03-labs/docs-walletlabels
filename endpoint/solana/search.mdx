...
api: "GET /api/solana/search/{searchtext}"
description: " This endpoint enables you to search and retrieve labels by a given search term. It's particularly useful for finding specific Solana accounts based on labels, types or subtypes."
---
...
```bash
curl --location --request GET 'https://api.walletlabels.xyz/api/solana/search/Uniswap?apikey=demo-api-key-x-00000' \

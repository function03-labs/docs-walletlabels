...
api: "GET https://api-c.walletlabels.xyz/avax/label"
description: "Retrieve user-friendly labels for Avax EOAs (Externally Owned Accounts) and Smart Contracts. Labels can be incredibly useful for categorizing your Avax interactions."
---
...
<ParamField query="address" type="string" required>
  Specify up to 10 Avax addresses for which you want to retrieve labels, separated
  by commas.
</ParamField>
...
<ResponseField name="address_name" type="string">
  The designated name associated with the specific Avax address.
</ResponseField>

{" "}

<ResponseField name="address" type="string">
  The Avax address for the label.
</ResponseField>
...
curl --location --request GET 'https://api-c.walletlabels.xyz/avax/address?address=0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f' \

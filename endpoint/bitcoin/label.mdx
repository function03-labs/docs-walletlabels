...
api: "GET /api/bitcoin/label/{address}"
description: "Retrieve user-friendly labels for Arbitrum EOAs (Externally Owned Accounts) and Smart Contracts. Labels can be incredibly useful for categorizing your Bitcoin interactions."
---

### Inputs

<ParamField path="address" type="string" required>
  Specify up the Bitcoin addresse for which you want to retrieve labels.
</ParamField>
...
<ResponseField name="data" type="array">
  An array that encapsulates the labels corresponding to the Bitcoin address provided.
...
<ResponseField name="address_name" type="string">
  The designated name associated with the specific Bitcoin address.
</ResponseField>

{" "}

<ResponseField name="address" type="string">
  The Bitcoin address for the label.
</ResponseField>
...
curl --location --request GET 'https://api-c.walletlabels.xyz/api/bitcoin/label/0xdef1c0ded9bec7f1a1670819833240f027b25eff?apikey=demo-api-key-x-00000' \

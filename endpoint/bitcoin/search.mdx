...
api: "GET /api/bitcoin/search/{searchtext}"
description: " This endpoint enables you to search and retrieve labels by a given search term. It's particularly useful for finding specific Bitcoin accounts based on labels, types or subtypes."
---
...
```bash
curl --location --request GET 'https://api-c.walletlabels.xyz/api/bitcoin/search/Uniswap?apikey=demo-api-key-x-00000' \

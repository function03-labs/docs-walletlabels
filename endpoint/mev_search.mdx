...
api: "GET https://api-c.walletlabels.xyz/ethereum/mev/search"
...
```bash
curl --location --request GET 'https://api-c.walletlabels.xyz/ethereum/mev/search?searchtext=sandwich' \

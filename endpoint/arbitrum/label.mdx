...
api: "GET /api/arbitrum/label/{address}"
...
<ParamField path="address" type="string" required>
  Specify up the Arbitrum addresse for which you want to retrieve labels.
</ParamField>
...
curl --location --request GET 'https://api-c.walletlabels.xyz/api/arbitrum/label/0xdef1c0ded9bec7f1a1670819833240f027b25eff?apikey=demo-api-key-x-00000' \

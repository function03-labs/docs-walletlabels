...
api: "GET https://api-c.walletlabels.xyz/arbitrum/label"
description: "Retrieve user-friendly labels for Arbitrum EOAs (Externally Owned Accounts) and Smart Contracts. Labels can be incredibly useful for categorizing your Arbitrum interactions."
---
...
<ParamField query="address" type="string" required>
  Specify up to 10 Arbitrum addresses for which you want to retrieve labels, separated
  by commas.
</ParamField>
...
curl --location --request GET 'https://api-c.walletlabels.xyz/arbitrum/label?address=0xdef1c0ded9bec7f1a1670819833240f027b25eff' \
  ...
  "data": [
    {
      ...
      "address_name": "exchange proxy",
      "label_type": "dex",
      "label_subtype": "general_contract",
      "label": "0x"
    },
    {
      "address": "0xdef1c0ded9bec7f1a1670819833240f027b25eff",

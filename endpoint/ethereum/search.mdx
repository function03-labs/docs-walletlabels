...
api: "GET /api/ethereum/search/{searchtext}"
description: " This endpoint enables you to search and retrieve labels by a given search term. It's particularly useful for finding specific Ethereum accounts based on labels, types or subtypes."
---
...
```bash
curl --location --request GET 'https://api-c.walletlabels.xyz/api/ethereum/search/Uniswap?apikey=demo-api-key-x-00000' \

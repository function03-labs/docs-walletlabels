...
api: "GET /api/ethereum/label/{address}"
description: "Retrieve user-friendly labels for Ethereum EOAs (Externally Owned Accounts) and Smart Contracts. Labels can be incredibly useful for categorizing your Ethereum interactions."
---

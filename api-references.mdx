...
description: "Customize your Mintlify site in mint.json"
---
...
<Note>
  This feature is only available on the [growth
...
<Tip>
  Discover more ways to customize the UI by navigating to your docs in the
  browser and right clicking and pressing "Inspect" and finding matching ids or
  classes for the component you want to style.
</Tip>